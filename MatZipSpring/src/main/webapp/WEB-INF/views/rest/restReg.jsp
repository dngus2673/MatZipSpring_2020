...
<div id="sectionContainerCenter">
	...
	<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=1965125d8bfdc12035fae1f11ca346bd&libraries=services"></script>
	<script>
		...
		function getLatLng() {
			...
			geocoder.addressSearch(addrStr, function(result, status) {
				if (status === kakao.maps.services.Status.OK) {
			        ...
			        if(result.length > 0){
			        	resultGetLatLng.innerText = 'done_outline'
